...
public class CustomerProgramDAO {
    ...
    public List<CustomerProgramDTO> getCustomerProgramsByTrainerId(int trainerId) {
        ...
        String sql = "SELECT cp.Id, cp.CustomerID, cp.ProgramID, cp.StartDate, cp.AssignedAt, u.Name AS CustomerName, u.AvatarUrl, p.Name AS ProgramName " +
        ...
        System.out.println(customerPrograms);
