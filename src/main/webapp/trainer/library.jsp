    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        <%@ page import="dao.ExerciseLibraryDAO, java.util.List, model.ExerciseLibrary, model.User" %>
            <% User user=(User) session.getAttribute("user"); if (user==null ||
                !"Trainer".equalsIgnoreCase(user.getRole())) { response.sendRedirect("login.jsp"); return; }
                ExerciseLibraryDAO dao=new ExerciseLibraryDAO(); List<ExerciseLibrary> exercises =
                dao.getAllExercises(user.getUserId());
                ...
                <body>
                    <div class="d-flex">
                        ...
                        <div class="flex-grow-1 p-4 bg-light">
                            ...
                            <input id="searchInput" class="form-control mb-3" placeholder="Search exercises..."
                                            ...
                                            <tr class="exercise-row">
                                                ...
                                                <td class="text-center">
                                                    <div class="action-buttons d-flex justify-content-center gap-2">
                                                        ...
                                                        <form
                                                            action="${pageContext.request.contextPath}/DeleteExerciseLibraryServlet"
