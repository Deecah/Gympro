    ...
    <body>
        <div class="d-flex">
            ...
            <div class="flex-grow-1 p-4 bg-light">
                ...
                <form action="<%= request.getContextPath() %>/CreateExerciseServlet" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="muscleGroup" class="form-control" required/>
                    </div>
