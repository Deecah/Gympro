    ...
    <%@ taglib uri="jakarta.tags.core" prefix="c" %>
        <%@ page import="java.util.List" %>
            <%@ page import="model.ExerciseLibrary" %>
                <% List<ExerciseLibrary> exerciseLibraries = (List<ExerciseLibrary>)
                        request.getAttribute("exerciseLibraries");
                        %>
                        <!DOCTYPE html>
                        <html>
                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1 p-4">
                                    ...
                                    <div class="form-container">
                                        ...
                                        <form action="<%= request.getContextPath() %>/CreateExerciseServlet"
                                            method="post" enctype="multipart/form-data"
                                            onsubmit="return validateForm()">
                                            <input type="hidden" name="workoutId" value="<%= request.getParameter("
                                                workoutId") !=null ? request.getParameter("workoutId") : "" %>"/>

                                            <div class="mb-3">
                                                <label class="form-label"><i class="fas fa-list me-2"></i>Select from
                                                    Exercise Library (Optional)</label>
                                                <select name="exerciseLibraryId" class="form-select"
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label"><i class="fas fa-file-alt me-2"></i>Exercise
                                                    Name</label>
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label"><i
                                                        class="fas fa-info-circle me-2"></i>Description</label>
                                                <textarea name="description" class="form-control"
                                                    placeholder="Enter exercise description..." rows="3"></textarea>
                                            </div>

                                            <div class="mb-3">
                                                <label class="form-label"><i class="fas fa-dumbbell me-2"></i>Muscle
                                                    Group</label>
                                                <input type="text" name="muscleGroup" class="form-control"
                                                    placeholder="e.g., Chest, Back" required />
                                            </div>

                                            <div class="mb-3">
                                                <label class="form-label"><i
                                                        class="fas fa-tools me-2"></i>Equipment</label>
                                                <input type="text" name="equipment" class="form-control"
                                                    placeholder="e.g., Dumbbells, Barbell" required />
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="reps" class="form-control"
                                                    placeholder="Number of reps" min="1" required />
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="restTimeSeconds" class="form-control"
                                                    placeholder="Rest time in seconds" min="0" required />
                                            </div>

                                            <div class="mb-3">
                                                <label class="form-label"><i class="fas fa-video me-2"></i>Upload
                                                    Exercise Video</label>
                                                <input type="file" id="videoUpload" name="videoFile" accept="video/*"
                                                    class="form-control" onchange="previewVideo(event)" />
                                            ...
                                            <button type="submit" class="btn btn-success"><i
                                                    class="fas fa-check me-2"></i>Save Exercise</button>
                                            <a href="<%= request.getContextPath() %>/trainer/library.jsp?action=list"
