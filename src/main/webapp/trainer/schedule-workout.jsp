                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1 p-4">
                                                <div class="calendar-container">
                                                    <h3 class="mb-4"><i class="fas fa-calendar-alt me-2"></i>Schedule
                                                        Workouts</h3>
                                                    <div id="calendar"></div>
                                                </div>

                                                <!-- Modal for Adding Workout -->
                                                <div class="modal fade" id="scheduleWorkoutModal" tabindex="-1"
                                                    aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <form
                                                            action="<%= request.getContextPath() %>/AddWorkoutToScheduleServlet"
                                                            method="post" class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"><i
                                                                        class="fas fa-calendar-plus me-2"></i>Schedule
                                                                    Workout</h5>
                                                            ...
                                                            <div class="modal-body">
                                                                <input type="hidden" name="programId"
                                                                    value="<%= request.getParameter(" programId") %>"/>
                                                                <div class="mb-3">
                                                                    <label class="form-label"><i
                                                                            class="fas fa-dumbbell me-2"></i>Workout
                                                                        Title</label>
                                                                ...
                                                                <div class="mb-3">
                                                                    <label class="form-label"><i
                                                                            class="fas fa-list me-2"></i>Select Exercise
                                                                        from Library</label>
                                                                    <select name="workoutLibraryId" class="form-select"
                                                                        required>
                                                                        <c:forEach var="exercise"
                                                                            items="${exerciseLibraries}">
                                                                ...
                                                                <div class="mb-3">
                                                                    <label class="form-label"><i
                                                                            class="fas fa-calendar-alt me-2"></i>Workout
                                                                        Date</label>
                                                                ...
                                                                <div class="mb-3">
                                                                    <label class="form-label"><i
                                                                            class="fas fa-clock me-2"></i>Start
                                                                        Time</label>
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="submit" class="btn btn-success"><i
                                                                        class="fas fa-check me-2"></i>Schedule
                                                                    Workout</button>
