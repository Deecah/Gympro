<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    <%@ page import="model.User" %>
        <% String context=request.getContextPath(); User user=(User) session.getAttribute("user"); String
            avatarUrl=(user !=null && user.getAvatarUrl() !=null && !user.getAvatarUrl().isEmpty()) ?
            user.getAvatarUrl() : context + "/img/default-avatar.jpg" ; %>
            ...
            <div id="sidebar" class="bg-dark text-white p-3 d-flex flex-column">
                <a href="<%= context %>/CustomerServlet"
                ...
                <ul class="nav nav-pills flex-column mb-auto text-start">
                    <li class="nav-item mb-2">
                        <a href="<%= context %>/CustomerServlet"
                            class="nav-link text-white btn btn-dark w-100 text-start">
                            <i class="fas fa-users me-2"></i>Customers
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href="<%= context %>/trainer/library.jsp"
                            class="nav-link text-white btn btn-dark w-100 text-start">
                            <i class="fas fa-dumbbell me-2"></i>Library
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href="<%= context %>/ProgramServlet"
                            class="nav-link text-white btn btn-dark w-100 text-start">
                            <i class="fas fa-clipboard-list me-2"></i>Programs
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href="<%= context %>/TrainerPackageServlet"
                            class="nav-link text-white btn btn-dark w-100 text-start">
                            <i class="fas fa-box me-2"></i>Packages
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href="<%= context %>/ScheduleServlet"
                            class="nav-link text-white btn btn-dark w-100 text-start">
                    ...
                    <li class="mb-2">
                        <a href="#"
                            class="nav-link text-white btn btn-dark w-100 text-start d-flex justify-content-between align-items-center">
                ...
                <div class="header-avatar position-relative text-center">
                    ...
                    <div class="mt-2">
                        <%= user !=null ? user.getUserName() : "Trainer" %>
                    </div>
                    <div id="dropdownMenu">
