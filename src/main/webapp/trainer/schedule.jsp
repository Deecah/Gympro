                        ...
                        <tbody>
                            <c:forEach var="customerProgram" items="${customerPrograms}">
                                <tr>
                                    ...
                                    <td>
                                        <a class="action-link"
                                            href="${pageContext.request.contextPath}/TimetableServlet?customerProgramId=${customerProgram.id}&programId=${customerProgram.programId}&startDate=${customerProgram.startDate}&endDate=${customerProgram.endDate}&trainerId=${trainerId}&scheduleId=${customerProgram.scheduleId}">View
                                            Schedule</a>
                                    </td>
                                </tr>
                            </c:forEach>
