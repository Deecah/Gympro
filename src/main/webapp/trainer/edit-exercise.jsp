            ...
            <div class="form-container">
                ...
                <form action="<%= request.getContextPath() %>/EditExerciseServlet" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" class="form-control" rows="3"><%= exercise.getDescription() != null ? exercise.getDescription() : "" %></textarea>
                    </div>

                    <div class="mb-3">
                        <label class="form-label"><i class="fas fa-dumbbell me-2"></i>Muscle Group</label>
                        <input type="text" name="muscleGroup" class="form-control" value="<%= exercise.getMuscleGroup() != null ? exercise.getMuscleGroup() : "" %>" required/>
                    </div>

                    <div class="mb-3">
                        <label class="form-label"><i class="fas fa-tools me-2"></i>Equipment</label>
                        <input type="text" name="equipment" class="form-control" value="<%= exercise.getEquipment() != null ? exercise.getEquipment() : "" %>" required/>
                    </div>

                    <div class="mb-3">
                        <label class="form-label"><i class="fas fa-repeat me-2"></i>Sets</label>
                        <input type="number" name="sets" class="form-control" value="<%= exercise.getSets() %>" min="1" required/>
                    </div>

                    <div class="mb-3">
                        <label class="form-label"><i class="fas fa-redo me-2"></i>Reps</label>
                        <input type="number" name="reps" class="form-control" value="<%= exercise.getReps() %>" min="1" required/>
                    </div>

                    <div class="mb-3">
                        <label class="form-label"><i class="fas fa-clock me-2"></i>Rest Time (seconds)</label>
                        <input type="number" name="restTimeSeconds" class="form-control" value="<%= exercise.getRestTimeSeconds() %>" min="0" required/>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <video id="editVideoPreview" class="video-preview" controls style="display: none;">
                            Your browser does not support the video tag.
                        </video>
                    </div>

                    <button type="submit" class="btn btn-primary"><i class="fas fa-check me-2"></i>Update Exercise</button>
