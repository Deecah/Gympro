            ...
            <% // Đảm bảo weekStartDate có giá trị mặc định nếu không được truyền String
                ...
                <body>
                    <div class="container">
                        ...
                        <a class="mb-3 text-start btn btn-outline-primary"
                            href="${pageContext.request.contextPath}/CustomerScheduleServlet?trainerId=${trainerId}">&larr;
                            Back to list</a>
                                                ...
                                                <c:if
                                                    ...
                                                    <div class="workout-box">
                                                        ...
                                                        <c:choose>
                                                            ...
                                                            <c:otherwise>
                                                                <span class="badge bg-danger">Not complete yet
                                                                    &#10007;</span>
                                                            </c:otherwise>
                                                        </c:choose>
                                                    </div>
